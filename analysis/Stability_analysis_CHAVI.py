...
def main():
    ...
    meta_data.index = [subject.replace('boydlab:', '') for subject in meta_data.index]
    ...
    mat.index = mat.index.str.strip('boydlab:')
    ...
    meta_data_copy = meta_data['hiv_status']
    ...
    for train_index, test_index in cv.split(mat, meta_data_copy):
        clf.fit(mat.iloc[train_index], meta_data_copy.iloc[train_index])
    ...
    df2.to_csv('stability_analysis_for_lasso_features_repeatedstratified_10_25_24.csv')
